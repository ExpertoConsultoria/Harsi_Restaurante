...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="hidden-sm hidden-xs col-md-4">
                <a id="incidenciasDiarias" name="incidenciasDiarias" onclick=" incidenciasDiarias()"
            ...
            <div class="hidden-sm hidden-xs col-md-4">
                <a id="incidenciasMensuales" name="incidenciasMensuales" onclick=" incidenciasMensuales()"
                    class="btn btn-default btn-lg btn-block" style="margin-top:10px; background-color: white;">
            ...
            <div class="modal-body">
                ...
                <form method="post" id="sample_form1" class="form-horizontal" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select id="estado1" type="text" class="form-control" name="estado1"
                                value="{{ old('estado1') }}" required>
                                <option id="0" selected="" disabled="" value="{{ old('estado1') }}">Seleccione el año
                                </option>
                    ...
                    <div class="form-group" align="center">
                        ...
                        <input type="submit" name="action_button" id="action_button1" class="btn btn-warning"
                            value="Add1" />
                    </div>
                </form>
            </div>
                ...
                <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <select id="estado" type="text" class="form-control" name="estado"
                                value="{{ old('estado_id') }}" required>
                                <option id="0" selected="" disabled="" value="{{ old('estado') }}">Seleccione el año
                                </option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select id="meses" type="text" class="form-control" name="meses"
                                value="{{ old('meses_id') }}" required>
                                <option id="0" selected="" disabled="" value="{{ old('estado') }}">Seleccione el mes
                                </option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                ...
                <form method="post" id="sample_form2" class="form-horizontal" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select id="estado2" type="text" class="form-control" name="estado2"
                                value="{{ old('estado2') }}" required>
                                <option id="0" selected="" disabled="" value="{{ old('estado2') }}">Seleccione la mesa
                                </option>
                    ...
                    <div class="form-group" align="center">
                        ...
                        <input type="hidden" name="hidden_id" id="hidden_id" />
                        <input type="submit" name="action_button2" id="action_button2" class="btn btn-warning"
                            value="Add2" />
                    </div>
                </form>
            </div>
                ...
                <form method="post" id="sample_form4" class="form-horizontal" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <select id="estado4" type="text" class="form-control" name="estado4"
                                value="{{ old('estado4') }}" required>
                                <option id="0" selected="" disabled="" value="{{ old('estado4') }}">Seleccione la lista
                                </option>
                    ...
                    <div class="form-group" align="center">
                        ...
                        <input type="hidden" name="hidden_id" id="hidden_id" />
                        <input type="submit" name="action_button4" id="action_button4" class="btn btn-warning"
                            value="Add4" />
                    </div>
                </form>
            </div>
...
<div id="formModal6" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <span id="form_result"></span>
                <form method="post" id="sample_form6" class="form-horizontal" enctype="multipart/form-data"
                    autocomplete="off">
                    <meta name="csrf-token" content="{{ csrf_token() }}">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <select id="tipo6" type="text" class="form-control" name="tipo6" value="{{ old('tipo6') }}"
                                required>
                                <option id="0" selected="" disabled="" value="{{ old('tipo6') }}">Seleccione el tipo de
                                    incidencia</option>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2">Mesa</label>
                        <div class="col-md-8">
                            <select id="estado6" type="text" class="form-control" name="estado6"
                                value="{{ old('estado6') }}" required>
                                <option id="0" selected="" disabled="" value="{{ old('estado6') }}">Seleccione la mesa
                                </option>
                                <option value="4">Todas</option>
                                <option value="3">Restaurante</option>
                                <option value="2">Apps</option>
                    ...
                    <div class="form-group" align="center">
                        ...
                        <input type="submit" name="action_button6" id="action_button6" class="btn btn-warning"
                            value="Add6" />
                    </div>
                </form>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" id="sample_form7" class="form-horizontal" enctype="multipart/form-data"
                    autocomplete="off">
                    <meta name="csrf-token" content="{{ csrf_token() }}">
                    <div class="form-group">
                        <label class="control-label col-md-2">Tipo incidencia</label>
                        <div class="col-md-8">
                            <select id="tipo7" type="text" class="form-control" name="tipo7" value="{{ old('tipo7') }}"
                                required>
                                <option id="0" selected="" disabled="" value="{{ old('tipo7') }}">Seleccione el tipo de
                                    incidencia</option>
                                <option value="1">Mesas canceladas</option>
                                <option value="2">Productos eliminados</option>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <select id="estado7" type="text" class="form-control" name="estado7"
                                value="{{ old('estado7') }}" required>
                                <option id="0" selected="" disabled="" value="{{ old('estado7') }}">Seleccione el año
                                </option>
                                @foreach ($variable3 as $g)
                                <option value="{{$g}}">{{$g}}</option>
                                @endforeach
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2" id="lbmeses">Meses</label>
                        <div class="col-md-8">
                            <select id="meses7" type="text" class="form-control" name="meses7"
                                value="{{ old('meses7') }}" required>
                                <option id="0" selected="" disabled="" value="{{ old('meses7') }}">Seleccione el mes
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group" align="center">
                        ...
                        <input type="submit" name="action_button7" id="action_button7" class="btn btn-warning"
                            value="Add7" />
                    </div>
                </form>
            </div>
            ...
            $.ajax({
                ...
                success: function (respuesta) {
                    $("#meses3").html(
                        '<option value="" selected="true"> Seleccione el mes </option>');
                    respuesta.forEach(element => {
                        $('#meses3').append('<option value=' + element.id + '> ' + element
                            .mes + ' </option>')
                    });
                }
            });
            ...
            $.ajax({
                ...
                success: function (respuesta) {
                    $("#meses5").html(
                        '<option value="" selected="true"> Seleccione el mes </option>');
                    respuesta.forEach(element => {
                        $('#meses5').append('<option value=' + element.id + '> ' + element
                            .mes + ' </option>')
                    });
                }
            });
