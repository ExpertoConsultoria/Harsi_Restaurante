...
@section('content')
    ...
    <h2 class="my-3">Guías del Restaurante</h1>
    ...
    <div class="container pb-5">
        <div class="row justify-content-center align-items-center g-2">
            <div class="pt-3 table-responsive col-12">
                <table class="table table-sm table-bordered table-striped table-hover" id="guide_table">
                    <thead>
                        <tr>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#create_record').click(function () {
                $('.modal-title').text("Agregar nuevo Guía");
                ...
                if($('#action').val() == 'Add')
                {
                    $.ajax({
                        ...
                        success:function(data)
                        {
                            ...
                            $('#sample_form')[0].reset();
                            $('#guide_table').DataTable().ajax.reload();
            ...
            $(document).on('click', '.edit', function(){
                ...
                $.ajax({
                    ...
                    success:function(html){
                        ...
                        $('.modal-title').text("Modificar Guía");
            ...
            $(document).on('click', '.delete', function () {
                guide_id = $(this).attr('id');
                $('#confirmModal').modal('show');
            });
            $('#delete_button').click(function () {
                $.ajax({
                    url: "guias/destroy/" + guide_id,
                    beforeSend: function () {
